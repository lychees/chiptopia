...
Example.ChivalricOrder = function() {
    ...
    let p1 = new Array // 玩家 1
    let p2 = new Array // 玩家 2
    let p3 = new Array // 中立
    ...
    function draw() {
      ...
      noStroke();
      fill(255, 100, 100);
      text("Red", width/2 - 100, height/16);
      fill(100, 100, 255);
      text("Blue", width/2 + 50, height/16)
      fill(4);
      textSize(48);
    ...
    function mousePressed() {
        p3.push(new Chip(mouseX, mouseY, p3_color))
    }
    ...
    function setup() {
        ...
        for (i=0;i<5;++i) {
            p1.push(new Chip(50 , y-100 + i*50, p1_color))
            p2.push(new Chip(width-50 , y-100 + i*50, p2_color))
        }

        ball = new Chip(width/2, 15, p3_color)
        console.log(ball)
    }
